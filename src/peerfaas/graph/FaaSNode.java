...
import fungus.FungalGrowth;
import fungus.HyphaData;
import fungus.HyphaLink;
import fungus.MycoCast;
import peersim.config.Configuration;
import peersim.core.GeneralNode;
import peersim.core.Node;

public class FaaSNode extends GeneralNode implements Node, Comparable {
  ...
  public boolean contains(FaaSNode neighbor) {
    return getHyphaLink().contains(neighbor);
  }

  public boolean isDisconnected(FaaSNode neighbor) {
  ...
  public int compareTo(Object o) {
    if (!(o instanceof FaaSNode)) {
      throw new ClassCastException();
    }
    FaaSNode other = (FaaSNode) o;
